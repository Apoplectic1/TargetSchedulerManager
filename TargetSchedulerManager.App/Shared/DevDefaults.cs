...
/// there is deliberately no TSM-shared assembly, and machine paths must not live in the consumer-neutral
...
/// <c>Processing\Catalog\TS Database\</c> — one location TSM + IS both read (<c>schedulerdb - Copy.sqlite</c>
